...
namespace WaterCity.Repository.Migrations
{
    ...
    [Migration("20230706125445_Update1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.DoiTuongGiaEntity", b =>
                {
                    ...
                    b.Property<decimal?>("TinhPhiDuyTri")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.DongHoNuocEntity", b =>
                {
                    ...
                    b.Property<string>("DongHoChinhId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.HoaDonEntity", b =>
                {
                    ...
                    b.Property<string>("HopDongNavigationId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ThongBaoNavigationId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("HopDongNavigationId");

                    b.HasIndex("ThongBaoNavigationId");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.HopDongEntity", b =>
                {
                    ...
                    b.Property<string>("TuyenDocNavigationId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("TuyenDocNavigationId");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.KhuVucEntity", b =>
                {
                    ...
                    b.Property<string>("VungNavigationId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("VungNavigationId");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.NhatKyHoaDonEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.SoDocChiSoEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.SuCoEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.ThatThoatEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.ThongBaoEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.TrangThaiGhiEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.TuyenDocEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.TyLeBaoPhuEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("TyLeBaoPhu");
                });

            modelBuilder.Entity("WaterCity.Repository.Models.VungEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.ChiSoDongHoEntity", b =>
                {
                    ...
                    b.HasOne("WaterCity.Repository.Models.SoDocChiSoEntity", "SoDocChiSo")
                        .WithMany("ChiSoDongHos")
                        .HasForeignKey("SoDocChiSoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WaterCity.Repository.Models.TrangThaiGhiEntity", "TrangThaiGhi")
                        .WithMany("ChiSoDongHo")
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.DongHoNuocSuCoEntity", b =>
                {
                    ...
                    b.HasOne("WaterCity.Repository.Models.SuCoEntity", "SuCo")
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.HoaDonEntity", b =>
                {
                    b.HasOne("WaterCity.Contract.Repository.Models.HopDongEntity", "HopDongNavigation")
                        .WithMany("HoaDon")
                        .HasForeignKey("HopDongNavigationId");

                    b.HasOne("WaterCity.Repository.Models.ThongBaoEntity", "ThongBaoNavigation")
                        .WithMany("HoaDons")
                        .HasForeignKey("ThongBaoNavigationId");

                    b.Navigation("HopDongNavigation");

                    b.Navigation("ThongBaoNavigation");
                });
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.HopDongEntity", b =>
                {
                    ...
                    b.HasOne("WaterCity.Repository.Models.TuyenDocEntity", "TuyenDocNavigation")
                        .WithMany("HopDongs")
                        .HasForeignKey("TuyenDocNavigationId");

                    b.Navigation("DanhSachDoiTuongGia");

                    b.Navigation("KhachHang");

                    b.Navigation("TuyenDocNavigation");
                });

            modelBuilder.Entity("WaterCity.Contract.Repository.Models.KhuVucEntity", b =>
                {
                    b.HasOne("WaterCity.Repository.Models.VungEntity", "VungNavigation")
                        .WithMany("KhuVucs")
                        .HasForeignKey("VungNavigationId");

                    b.Navigation("VungNavigation");
                });
            ...
            modelBuilder.Entity("WaterCity.Repository.Models.SoDocChiSoEntity", b =>
                {
                    ...
                    b.HasOne("WaterCity.Repository.Models.TuyenDocEntity", "TuyenDoc")
